namespace FIVESTARVC.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FIVESTARVC.DAL.ResidentContext>
    {
        ...
        protected override void Seed(FIVESTARVC.DAL.ResidentContext context)
        {
            ...
            Rooms.ForEach(m => context.Rooms.AddOrUpdate(m));
            context.SaveChanges();
            ...
            programs.ForEach(p => context.ProgramTypes.AddOrUpdate(p));
            context.SaveChanges();
            ...
            militaryCampaigns.ForEach(m => context.MilitaryCampaigns.AddOrUpdate(m));
            context.SaveChanges();
        }
    }
}
